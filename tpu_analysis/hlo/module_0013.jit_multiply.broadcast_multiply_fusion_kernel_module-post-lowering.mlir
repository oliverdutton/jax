module @broadcast_multiply_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @broadcast_multiply_fusion_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 16384 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, llvm.noalias, xla.invariant}, %arg2: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 16384 : index, llvm.noalias}, %arg3: i64, %arg4: i64, %arg5: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
    %0 = llvm.mlir.constant(1 : index) : i64
    %1 = llvm.mlir.constant(0 : index) : i64
    %2 = llvm.mlir.constant(64 : index) : i64
    %3 = llvm.getelementptr inbounds %arg1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1 x f32>
    %4 = llvm.load %3 invariant : !llvm.ptr -> f32
    llvm.br ^bb1(%1 : i64)
  ^bb1(%5: i64):  // 2 preds: ^bb0, ^bb5
    %6 = llvm.icmp "slt" %5, %2 : i64
    llvm.cond_br %6, ^bb2, ^bb6
  ^bb2:  // pred: ^bb1
    %7 = llvm.mul %5, %2 overflow<nsw> : i64
    llvm.br ^bb3(%1 : i64)
  ...
  ^bb4:  // pred: ^bb3
    ...
    %11 = llvm.getelementptr inbounds %arg0[0, %10] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<4096 x f32>
    %12 = llvm.load %11 invariant : !llvm.ptr -> f32
    %13 = llvm.fmul %12, %4 : f32
    %14 = llvm.getelementptr inbounds %arg2[0, %10] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<4096 x f32>
    llvm.store %13, %14 : f32, !llvm.ptr
    %15 = llvm.add %8, %0 : i64
    llvm.br ^bb3(%15 : i64)
  ^bb5:  // pred: ^bb3
    %16 = llvm.add %5, %0 : i64
    llvm.br ^bb1(%16 : i64) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  ^bb6:  // pred: ^bb1
    llvm.return
  }
}