module @broadcast_multiply_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @broadcast_multiply_fusion_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, llvm.noalias, xla.invariant}, %arg2: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, llvm.noalias}, %arg3: i64, %arg4: i64, %arg5: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %12 = llvm.getelementptr inbounds %arg0[0, %11] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2048 x f32>
    %13 = llvm.load %12 invariant : !llvm.ptr -> f32
    %14 = llvm.fmul %13, %5 : f32
    %15 = llvm.getelementptr inbounds %arg2[0, %11] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2048 x f32>
    llvm.store %14, %15 : f32, !llvm.ptr
    %16 = llvm.add %9, %0 : i64
    llvm.br ^bb3(%16 : i64)
  ^bb5:  // pred: ^bb3
    %17 = llvm.add %6, %0 : i64
    llvm.br ^bb1(%17 : i64) {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
  ^bb6:  // pred: ^bb1
    llvm.return
  }
}