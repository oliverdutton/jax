module @broadcast_multiply_fusion_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  func.func @broadcast_multiply_fusion(%arg0: tensor<2048xi32> {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, xla.invariant, xla.slice_index = 0 : index}, %arg1: tensor<2048xi32> {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, xla.invariant, xla.slice_index = 1 : index}, %arg2: tensor<2048xf32> {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, xla.slice_index = 2 : index}) -> tensor<2048xf32> attributes {xla.backend_kind = #xla.backend_kind<cpu>, xla.entry} {
    ...
    %0 = xla.workgroup_id  x {xla.range = [0 : index, 2 : index]}
    %1 = arith.cmpi sle, %0, %c1 : index
    %2 = scf.if %1 -> (tensor<2048xf32>) {
      %3 = arith.cmpi sge, %0, %c0 : index
      %4 = arith.andi %3, %1 : i1
      %5 = scf.if %4 -> (tensor<2048xf32>) {
        %6 = scf.for %arg3 = %c0 to %c22 step %c1 iter_args(%arg4 = %arg2) -> (tensor<2048xf32>) {
          %7 = scf.for %arg5 = %c0 to %c32 step %c1 iter_args(%arg6 = %arg4) -> (tensor<2048xf32>) {
            %8 = xla.apply_indexing #xla.indexing_map<"(d0, bl_x, d2) -> (bl_x * 704 + d2 * 32 + d0), domain: d0 in [0, 31], bl_x in [0, 1], d2 in [0, 21]">(%arg5, %0, %arg3)
            %extracted = tensor.extract %arg0[%8] : tensor<2048xi32>
            %extracted_26 = tensor.extract %arg1[%8] : tensor<2048xi32>
            ...
            %inserted = tensor.insert %56 into %arg6[%8] : tensor<2048xf32>
            scf.yield %inserted : tensor<2048xf32>
          }
          scf.yield %7 : tensor<2048xf32>
        } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
        scf.yield %6 : tensor<2048xf32>
      } else {
        scf.yield %arg2 : tensor<2048xf32>
      }
      scf.yield %5 : tensor<2048xf32>
    } else {
      %3 = arith.cmpi eq, %0, %c2 : index
      %4 = scf.if %3 -> (tensor<2048xf32>) {
        %5 = scf.for %arg3 = %c0 to %c20 step %c1 iter_args(%arg4 = %arg2) -> (tensor<2048xf32>) {
          %6 = scf.for %arg5 = %c0 to %c32 step %c1 iter_args(%arg6 = %arg4) -> (tensor<2048xf32>) {
            %7 = xla.apply_indexing #xla.indexing_map<"(d0, d1) -> (d1 * 32 + d0 + 1408), domain: d0 in [0, 31], d1 in [0, 19]">(%arg5, %arg3)
            %extracted = tensor.extract %arg0[%7] : tensor<2048xi32>
            %extracted_26 = tensor.extract %arg1[%7] : tensor<2048xi32>
            ...
            %inserted = tensor.insert %55 into %arg6[%7] : tensor<2048xf32>
            scf.yield %inserted : tensor<2048xf32>
          }
          scf.yield %6 : tensor<2048xf32>
        } {loop_annotation = #llvm.loop_annotation<unroll = <disable = true>>}
