module @broadcast_add_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  llvm.func internal @broadcast_add_fusion.3_wrapped(%arg0: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 8 : index, llvm.noalias, xla.invariant}, %arg1: !llvm.ptr {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, llvm.noalias}, %arg2: i64, %arg3: i64, %arg4: i64) attributes {always_inline, sym_visibility = "private", xla.backend_kind = #xla.backend_kind<cpu>, xla.cpu.is_wrapped, xla.entry} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    %18 = llvm.getelementptr inbounds %arg1[0, %17] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.array<2048 x i32>
    llvm.store %16, %18 : i32, !llvm.ptr
    %19 = llvm.add %11, %2 : i64
    llvm.br ^bb3(%19 : i64)
  ^bb5:  // pred: ^bb3
    %20 = llvm.add %7, %2 : i64
