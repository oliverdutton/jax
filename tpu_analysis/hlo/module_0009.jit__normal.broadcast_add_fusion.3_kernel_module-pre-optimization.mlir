module @broadcast_add_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  ...
  func.func private @fused_computation_6_add_119(%arg0: tensor<2xi32>, %arg1: index {xla.range = [0 : index, 15 : index]}, %arg2: index {xla.range = [0 : index, 63 : index]}) -> i32 attributes {llvm.linkage = #llvm.linkage<internal>} {
