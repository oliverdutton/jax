module @broadcast_add_fusion.3_kernel_module attributes {dlti.dl_spec = #dlti.dl_spec<index = 64 : i32>, xla.cpu_memory_region_name = "xla_cpu_emitter__loop_fusion_kernel_emitter__hlo_opcode__fusion"} {
  func.func @broadcast_add_fusion.3(%arg0: tensor<2xi32> {llvm.align = 64 : index, llvm.dereferenceable = 8 : index, xla.invariant, xla.slice_index = 0 : index}, %arg1: tensor<1024xi32> {llvm.align = 64 : index, llvm.dereferenceable = 4096 : index, xla.slice_index = 1 : index}) -> tensor<1024xi32> attributes {xla.backend_kind = #xla.backend_kind<cpu>, xla.entry} {
    ...
    %0 = scf.for %arg2 = %c0 to %c16 step %c1 iter_args(%arg3 = %arg1) -> (tensor<1024xi32>) {
      ...
      %3 = scf.for %arg4 = %c0 to %c64 step %c1 iter_args(%arg5 = %arg3) -> (tensor<1024xi32>) {
        ...
        %9 = xla.apply_indexing #xla.indexing_map<"(d0, d1) -> (d0 * 64 + d1), domain: d0 in [0, 15], d1 in [0, 63]">(%arg2, %arg4)
        %inserted = tensor.insert %8 into %arg5[%9] : tensor<1024xi32>
        scf.yield %inserted : tensor<1024xi32>
      }
      scf.yield %3 : tensor<1024xi32>
