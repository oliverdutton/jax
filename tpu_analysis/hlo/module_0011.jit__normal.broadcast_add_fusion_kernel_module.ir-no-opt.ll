...
define internal void @broadcast_add_fusion_wrapped(ptr noalias align 64 dereferenceable(4) %0, ptr noalias align 64 dereferenceable(16) %1, ptr noalias align 64 dereferenceable(16384) %2, ptr noalias align 64 dereferenceable(16384) %3, ptr noalias align 64 dereferenceable(4) %4, ptr noalias align 64 dereferenceable(16384) %5, i64 %6, i64 %7, i64 %8) #1 {
  %10 = icmp sle i64 %6, 3
...
49:                                               ; preds = %46
  ...
  %51 = getelementptr inbounds [4096 x i32], ptr %2, i32 0, i64 %50
  %52 = load i32, ptr %51, align 4, !invariant.load !3
  %53 = shl i32 %52, %15
  %54 = select i1 %17, i32 %53, i32 0
  %55 = lshr i32 %52, %16
  %56 = select i1 %18, i32 %55, i32 0
  %57 = getelementptr inbounds [4096 x i32], ptr %3, i32 0, i64 %50
  ...
  %83 = add i32 %82, %35
  %84 = add i32 %83, %38
  %85 = getelementptr inbounds [4096 x i32], ptr %5, i32 0, i64 %50
...
93:                                               ; preds = %91
  %94 = getelementptr inbounds [4 x i32], ptr %1, i32 0, i32 0
  %95 = load i32, ptr %94, align 4, !invariant.load !3
  %96 = sub i32 32, %95
  %97 = icmp ult i32 %95, 32
  %98 = icmp ult i32 %96, 32
  %99 = getelementptr inbounds [4 x i32], ptr %1, i32 0, i32 1
  %100 = load i32, ptr %99, align 4, !invariant.load !3
  %101 = sub i32 32, %100
  %102 = icmp ult i32 %100, 32
  %103 = icmp ult i32 %101, 32
  %104 = getelementptr inbounds [4 x i32], ptr %1, i32 0, i32 2
  %105 = load i32, ptr %104, align 4, !invariant.load !3
  %106 = sub i32 32, %105
  %107 = icmp ult i32 %105, 32
  %108 = icmp ult i32 %106, 32
  %109 = getelementptr inbounds [4 x i32], ptr %1, i32 0, i32 3
  %110 = load i32, ptr %109, align 4, !invariant.load !3
  %111 = sub i32 32, %110
  %112 = icmp ult i32 %110, 32
  %113 = icmp ult i32 %111, 32
  %114 = getelementptr inbounds [1 x i32], ptr %0, i32 0, i32 0
  %115 = load i32, ptr %114, align 4, !invariant.load !3
  %116 = getelementptr inbounds [1 x i32], ptr %4, i32 0, i32 0
  %117 = load i32, ptr %116, align 4, !invariant.load !3
  %118 = add i32 %117, 1
  br label %119

119:                                              ; preds = %166, %93
  %120 = phi i64 [ %167, %166 ], [ 0, %93 ]
  %121 = icmp slt i64 %120, 12
  br i1 %121, label %122, label %89

122:                                              ; preds = %119
  %123 = mul nsw i64 %120, 64
  br label %124

124:                                              ; preds = %127, %122
  %125 = phi i64 [ %165, %127 ], [ 0, %122 ]
  %126 = icmp slt i64 %125, 64
  br i1 %126, label %127, label %166

127:                                              ; preds = %124
  %128 = add nsw i64 %123, %125
  %129 = add nsw i64 %128, 3328
  %130 = getelementptr inbounds [4096 x i32], ptr %2, i32 0, i64 %129
  %131 = load i32, ptr %130, align 4, !invariant.load !3
  %132 = shl i32 %131, %95
  %133 = select i1 %97, i32 %132, i32 0
  %134 = lshr i32 %131, %96
  %135 = select i1 %98, i32 %134, i32 0
  %136 = getelementptr inbounds [4096 x i32], ptr %3, i32 0, i64 %129
  %137 = load i32, ptr %136, align 4, !invariant.load !3
  %138 = or i32 %133, %135
  %139 = add i32 %137, %131
  %140 = xor i32 %139, %138
  %141 = shl i32 %140, %100
  %142 = select i1 %102, i32 %141, i32 0
  %143 = lshr i32 %140, %101
  %144 = select i1 %103, i32 %143, i32 0
  %145 = or i32 %142, %144
  %146 = add i32 %139, %140
  %147 = xor i32 %146, %145
  %148 = shl i32 %147, %105
  %149 = select i1 %107, i32 %148, i32 0
  %150 = lshr i32 %147, %106
  %151 = select i1 %108, i32 %150, i32 0
  %152 = or i32 %149, %151
  %153 = add i32 %146, %147
  %154 = xor i32 %153, %152
  %155 = shl i32 %154, %110
  %156 = select i1 %112, i32 %155, i32 0
  %157 = lshr i32 %154, %111
  %158 = select i1 %113, i32 %157, i32 0
  %159 = add i32 %153, %154
  %160 = or i32 %156, %158
  %161 = xor i32 %159, %160
  %162 = add i32 %161, %115
  %163 = add i32 %162, %118
  %164 = getelementptr inbounds [4096 x i32], ptr %5, i32 0, i64 %129
