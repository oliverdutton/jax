  ...
  func.func @broadcast_multiply_fusion(%arg0: tensor<2048xf32> {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, xla.invariant, xla.slice_index = 0 : index}, %arg1: tensor<f32> {llvm.align = 64 : index, llvm.dereferenceable = 4 : index, xla.invariant, xla.slice_index = 1 : index}, %arg2: tensor<2048xf32> {llvm.align = 64 : index, llvm.dereferenceable = 8192 : index, xla.slice_index = 2 : index}) -> tensor<2048xf32> attributes {xla.backend_kind = #xla.backend_kind<cpu>, xla.entry} {
    ...
    %0 = scf.for %arg3 = %c0 to %c64 step %c1 iter_args(%arg4 = %arg2) -> (tensor<2048xf32>) {
      %1 = scf.for %arg5 = %c0 to %c32 step %c1 iter_args(%arg6 = %arg4) -> (tensor<2048xf32>) {
        ...
        %inserted = tensor.insert %3 into %arg6[%2] : tensor<2048xf32>
